...
public abstract class ParameterizableViewTransformer implements CarouselView1.ViewTransformer {
    ...
    private float mOffsetXPercent = 0f, mOffsetYPercent = 0f;
    private float mMinScaleX = Float.NaN, mMaxScaleX = Float.NaN, mScaleXOffset = Float.NaN, mScaleXFactor = Float.NaN;
    private float mMinScaleY = Float.NaN, mMaxScaleY = Float.NaN, mScaleYOffset = Float.NaN, mScaleYFactor = Float.NaN;
    private float mRotateDegree = Float.NaN;
    private boolean mScaleLargestAtCenter = false;
