...
//    }
    ...
    public interface IConfigBuilder {
        TextDrawable.IConfigBuilder width(int width);

        TextDrawable.IConfigBuilder height(int height);

        TextDrawable.IConfigBuilder textColor(int color);

        TextDrawable.IConfigBuilder withBorder(int thickness);

        TextDrawable.IConfigBuilder useFont(Typeface font);

        TextDrawable.IConfigBuilder fontSize(int size);
    ...
    public interface IShapeBuilder {
        ...
        TextDrawable.IBuilder roundRect(int radius);
