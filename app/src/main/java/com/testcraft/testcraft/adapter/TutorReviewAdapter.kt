...
class TutorReviewAdapter(val context: Context, val dataList: ArrayList<TutorModel.TutorData>) :
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): viewholder {
        ...
        return viewholder(
            LayoutInflater.from(context).inflate(
                R.layout.list_item_tutor_review,
                p0,
                false
            )
        )
    ...
    class viewholder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var tutor_name: TextView = itemView.findViewById(R.id.tutor_item_tvName)
        var tutor_sname: TextView = itemView.findViewById(R.id.tutor_review_tvLogo)
        var remark: TextView = itemView.findViewById(R.id.tutor_item_tvDesc)
        var date: TextView = itemView.findViewById(R.id.tutor_item_tvDate)
        var rating: RatingBar = itemView.findViewById(R.id.tutor_review_rating)
