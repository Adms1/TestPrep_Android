...
class QuestionImagelistAdapter(
    val context: Context,
    val dataList: ArrayList<QuestionResponse.QuestionList>
) : RecyclerView.Adapter<QuestionImagelistAdapter.viewholder>() {
    ...
    override fun onBindViewHolder(p0: viewholder, p1: Int) {
        ...
        if ("http://content.testprep.co.in/question/" + dataList[p1].QuestionImage != "") {
            Picasso.get()
                .load("http://content.testprep.co.in/question/" + dataList[p1].QuestionImage)
                .into(p0.quesimg)
        }
        if ("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[0].AnswerImage != "") {
            Picasso.get()
                .load("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[0].AnswerImage)
                .into(p0.opone1)
        }
        if ("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[1].AnswerImage != "") {
            Picasso.get()
                .load("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[1].AnswerImage)
                .into(p0.optwo1)
        }
        if ("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[2].AnswerImage != "") {
            Picasso.get()
                .load("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[2].AnswerImage)
                .into(p0.opthree1)
        }
        if ("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[3].AnswerImage != "") {
            Picasso.get()
                .load("http://content.testprep.co.in/question/" + dataList[p1].StudentTestQuestionMCQ[3].AnswerImage)
                .into(p0.opfour1)
        }
