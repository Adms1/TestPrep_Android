...
import com.testcraftdemo.old.adapter.QuestionImagelistAdapter
 ...
 *
 */
class ImageListViewFragment : Fragment() {
        ...
        call.enqueue(object : Callback<QuestionResponse> {
            override fun onResponse(call: Call<QuestionResponse>, response: Response<QuestionResponse>) {
                ...
                if (response.body()!!.message == "Success") {
                    ...
                    main_question_list.adapter =
                        QuestionImagelistAdapter(activity!!, movies)
