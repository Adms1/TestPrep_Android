...
class TutorProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tutor_item_rvCuratorList.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
        tutor_item_rvCuratorList.adapter = TutorsAdapter(activity!!)
