...
class NewSelectSubjectAdapter(private val context: Context, employees: ArrayList<PackageData.PackageDataList>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MultiViewHolder {
        val view =
            LayoutInflater.from(context).inflate(com.testprep.R.layout.new_prefrence_item_layout, viewGroup, false)
    ...
    inner class MultiViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var title: TextView = itemView.findViewById(com.testprep.R.id.package_name)
        var stitle: TextView = itemView.findViewById(com.testprep.R.id.package_name_short)
        var p_select: ImageView = itemView.findViewById(com.testprep.R.id.package_select)

        fun bind(employee: PackageData.PackageDataList) {

            if (employee.isSelected) {
                title.setTextColor(context.resources.getColor(com.testprep.R.color.colorPrimaryDark))
                p_select.visibility = View.VISIBLE
            } else {
                title.setTextColor(context.resources.getColor(com.testprep.R.color.black))
...
//            p0.image.setImageDrawable(Utils.newcreateDrawable(dataList[p1].SubjectName.substring(0, 1)))
            ...
            itemView.setOnClickListener {
                ...
                if (employee.isSelected) {
                    ...
                    if (employee.Icon == null) {
                        image.setImageDrawable(context.resources.getDrawable(com.testprep.R.drawable.close_cancel))
                    }
                    ...
                    if (employee.Icon == null) {
                        image.setImageDrawable(context.resources.getDrawable(com.testprep.R.drawable.gray_bg))
                    }
                ...
                for (i in 0 until all!!.size) {
                    ...
                    Log.i("selected array: ", all!!.get(i).SubjectName + "[" + all!![i].isSelected + "]")
                }
